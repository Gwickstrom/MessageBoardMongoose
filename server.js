...
app.post("/comment/:id", function(req, res){
    // This is how a one to many relationship is processed using mongo, and a foreign key
...
const CommentSchema = new mongoose.Schema({
    name: String,
    text: String,
    // The underscore before message denotes that it is referencing another message
